...
axis(side = 2,
     ...
     las = 2)
lines(x = c(0, 1), y = rep(horsekick_cum[1], 2), lty = 1)
lines(x = c(1, 2), y = rep(horsekick_cum[2], 2), lty = 1)
lines(x = c(2, 3), y = rep(horsekick_cum[3], 2), lty = 1)
lines(x = c(3, 4), y = rep(horsekick_cum[4], 2), lty = 1)
lines(x = c(4, 5), y = rep(horsekick_cum[5], 2), lty = 1)
...
abline(v = 0:4, 
       lty = 3)
lines(c(0, 1), rep(horsekick_cum[1], 2), lty = 3)
lines(c(0, 2), rep(horsekick_cum[2], 2), lty = 3)
lines(c(0, 3), rep(horsekick_cum[3], 2), lty = 3)
lines(c(0, 4), rep(horsekick_cum[4], 2), lty = 3)
lines(c(0, 5), rep(horsekick_cum[5], 2), lty = 3)
```
